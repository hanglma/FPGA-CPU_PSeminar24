...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets core0/MUX_0/inst/O[0]_INST_0];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets core0/MUX_0/inst/O[1]_INST_0];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets core0/MUX_0/inst/O[2]_INST_0];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets core0/MUX_0/inst/O[3]_INST_0];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets core0/MUX_0/inst/O[4]_INST_0];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets core0/MUX_0/inst/O[5]_INST_0];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets core0/MUX_0/inst/O[6]_INST_0];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets core0/MUX_0/inst/O[7]_INST_0];
...
## Buttons
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { pmod_rst }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
#set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { pmod_bus_clk }]; #IO_L6P_T0_15 Sch=ja[4]
...
## Pmod Header JD
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {pmod_bus_clk_IBUF}]
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { pmod_bus_poti[0] }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { pmod_bus_poti[1] }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { pmod_bus_poti[2] }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { pmod_bus_clk }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { pmod_bus_pito[0] }]; #IO_L14P_T2_SRCC_35 Sch=jd[7]
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { pmod_bus_pito[1] }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { pmod_bus_pito[2] }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { pmod_bus_control }]; #IO_L15N_T2_DQS_35 Sch=jd[10]
